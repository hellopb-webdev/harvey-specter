      ...
      <div className="relative flex flex-col">
        ...
        <div className="flex flex-col gap-8 pt-12 pb-12 md:gap-12 md:pt-[120px] md:pb-[80px]">
          <div className="flex items-end justify-between gap-4">
            <p className={MONO_LABEL}>[ 002 — services ]</p>
            <p className={`${MONO_LABEL} text-right`}>[ 4 deliverables ]</p>
          </div>

          <h1
            ref={titleRef}
            className="font-medium uppercase leading-[0.84] tracking-[-0.07em] text-black text-[clamp(64px,18vw,140px)] md:text-[clamp(140px,16vw,260px)] will-change-transform"
          >
            Services
          </h1>
          ...
          >
            <p className="max-w-[640px] text-[18px] font-light italic uppercase leading-[1.2] tracking-[-0.04em] text-[#1f1f1f] md:text-[24px]">
              ...
              — brand, web, marketing, and the camera. End-to-end, or any one
              piece on its own.
            </p>
            <p className={`${MONO_LABEL} md:text-right`}>
              [ Studio of one — collaborators on call ]
            </p>
          </div>
        </div>
